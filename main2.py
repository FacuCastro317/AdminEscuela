...
from manip_bd import insertar_datos, mostrar_tabla
...
def consultar_datos():
    ...
    if opcion == 1:
        ...
        respuesta = input("¿Desea modificar algun dato?(Y/N)")
        ...
        mostrar_tabla("materias")
        respuesta = input("¿Desea modificar algun dato?(Y/N)")
        if respuesta == "Y" or respuesta == "y":
            modificar_dato("materias")
        elif respuesta == "N" or respuesta == "n":
            menu()
        else: 
            print("Opcion invalida.")
